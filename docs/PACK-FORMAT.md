...
| Durchsuchbarer Text je Paket | 4 500 000 Zeichen | dieser Text liegt beim Suchen vollständig im Speicher. Am 21.08.2026 von 4 000 000 angehoben und erstmals zusammen mit dem vollen Wortschatz gemessen: Bei 299 003 verschiedenen Wörtern und 96 MB Heap tragen 4 792 400 Zeichen noch, 5 320 400 nicht mehr. 4 500 000 liegt rund ein Sechstel unter dem letzten Stand, der getragen hat |
| Wortvorkommen im Suchindex je Paket | 750 000 | grobe zweite Schranke neben der Zeichengrenze. Ein weiteres Vorkommen kostet rund 17 Byte, viel weniger als ein neues Wort. Am 20.08.2026 gemessen: bei 30 000 verschiedenen Wörtern kosten 500 000 auf 1 000 000 Vorkommen zusätzliche 8,4 MB. Vorher 500 000 und 450 000, damals als Hauptgrenze — sie maß die billige Größe und bremste echten Inhalt aus. Am 21.08.2026 von 600 000 auf 750 000 angehoben und neu gemessen: Seit es die eigene Grenze auf verschiedene Wörter gibt, ist der teure Fall von damals gar nicht mehr baubar; beide Grenzen zugleich am Anschlag kosten rund 52 MB von 96 MB |
| Verschiedene Wörter im Suchindex je Paket | 300 000 | die Grenze, an der der Speicher wirklich hängt: Jedes verschiedene Wort braucht einen eigenen Eintrag im Wortverzeichnis und kostet rund 130 Byte, also etwa das Achtfache eines weiteren Vorkommens. Am 20.08.2026 getrennt gemessen, bei 96 MB Heap: 100 000 auf 300 000 verschiedene Wörter kosten zusätzliche 25,9 MB; ein Paket aus lauter verschiedenen Wörtern trägt bis 620 010 und läuft ab 630 012 über. 300 000 ist der vorsichtige Rand des gemessenen sicheren Bereichs (300 000 bis 516 675). Schlimmster Fall an beiden Grenzen zugleich: rund 49 MB von 96 MB. Das echte Europa-Paket hat 32 316 verschiedene Wörter bei 485 939 Vorkommen |
