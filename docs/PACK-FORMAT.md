...
| Wortvorkommen im Suchindex je Paket | 500 000 | das Zeichenbudget allein schützt nicht: viele kurze, verschiedene Wörter bleiben weit darunter und sprengen trotzdem das Wortverzeichnis, weil dort jedes Wort einen eigenen Eintrag kostet. Am 20.08.2026 gemessen, im TEUERSTEN Fall: ein Paket, in dem jedes Wort verschieden ist. Bei 96 MB Heap laden und indizieren 620 010 Wortvorkommen noch, ab 630 012 läuft der Speicher beim Bau des Index über. Eine frühere Angabe von 602 400 an dieser Stelle war falsch: Der Messtest konnte nur 456 976 verschiedene Wörter bilden und wiederholte sich darüber. Das echte Europa-Paket ist weit billiger — 477 698 Vorkommen, aber nur rund 32 000 verschiedene Wörter, jedes im Schnitt fünfzehnmal; gemessen 35 MB für Laden und Index. 500 000 bleibt rund ein Fünftel unter der gemessenen Wand. Diese Grenze misst allerdings die Vorkommen, während der Speicher an der Zahl der VERSCHIEDENEN Wörter hängt. Vorher 450 000 (17.08.2026), davor 300 000 |
